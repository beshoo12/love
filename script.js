...
let originalVolume = 0.55; // الصوت الأصلي
...
function lowerMusicVolume() {
    isVoicePlaying = true;
    audio.volume = 0.15; // 15% من الصوت (واطي جداً)
}
...
const messages = [
    { text: "..موافقة نرتبط ؟ 🌝🌚😂", sender: "بيشو" },
    { text: " Yes🌚", sender: "مارلين" },
    { text: "حسيت اني عايشه عشان حد جميل بيحبني وبحبه", sender: "مارلين" },
    { text: "انا بحببببك اووووي لبعد الحدوووود♥️♥️♥️", sender: "بيشو" },
    { text: "عشان انا وف حضنك بلاقي امان ودفي الدنيا كلها♥️♥️♥️", sender: "مارلين" },
    { text: "هتجوزك ياجمل و احلى مرموووووورى ف الدونياااا🌚🙈♥️♥️", sender: "بيشو" },
    { text: "بحبك فشششششششششخ يكتكوووووووووووووتة😘🫂🌚♥️♥️♥️🤭", sender: "بيشو" },
    { text: "بحبك جدا يمارلين🫂🫂🙈♥️♥️♥️", sender: "بيشو" },
    { text: "وانا كمان بموت فيكك🫂♥️♥️♥️♥️🥹", sender: "مارلين" },
    { text: "عشان انا وف حضنك بلاقي امان ودفي الدنيا كلها♥️♥️🫂", sender: "مارلين" },
    { text: "مش هنفع لحد غيرك ♥️♥️🌚", sender: "مارلين" },
    { text: "ربنا يخليكى لياا ومشوفش فيكى حاجه وحشه ابدااااا🫂🫂🥹♥️♥️", sender: "بيشو" },
    { text: "عشان انا مقدرش اعيش من غيرك بجددد🫂🥹♥️♥️♥️", sender: "مارلين" },
    { text: "الاحن والافضل والاقرب لقلبي🥹🫂♥️♥️♥️♥️", sender: "مارلين" },
    { text: "وانا كمان ....مكنتش اعرف ان كل الحب دا ليك انت بسسسس🫂🫂♥️♥️♥️🌚", sender: "بيشو" },
    { text: "احلي قعدت ثرابيست الواااحد بياخدها وهو معاك🌚🫂♥️♥️♥️♥️", sender: "مارلين" },
    { text: "ربنا يخليك ليا ومشوفش فيك حاجه وحشه ابدااااا🫂🫂♥️♥️", sender: "مارلين" },
    { text: "شكرا انك الجانب الحلو اللي دايما بفتكره واشكر ربنا عليه 🫂♥️♥️♥️", sender: "مارلين" },
    { text: "هتفضل انت الرااجل اللي بحلم اكمل معاه حياتي🫂🫂♥️♥️", sender: "مارلين" },
    { text: "انت كده كده🙈♥️♥️♥️♥️", sender: "مارلين" },
    { text: "اريد يدك وقلبك وعقلك اريد ان تلمس يدى يداكى .. وان يشعر قلبى بدم قلبك .. وان يبقى عقلى و فكرى منشغلا بكى حتى مماتى .. اريد ان اعاشرك  حياتى وتفاصيلى ... اريد ان نتزوج ونبنى اسرتنا الصغيره وحدنا دون وجود شخص اخر ف حياتنا ... ف هل تقبلى اميرتى ؟!🌚♥️🫶🏻🙈👑♥️", sender: "بيشو" },
    { text: "عندما يقف العقل عن التصديق و يرتفع الدوبامين لاخره .. تاكد انك تشاهد قلبك بعينيك و هكذا تصبح نظراتك الية ♥️♥️♥️", sender: "بيشو" },
    { text: "بنصلي لربنا يبقي معانا ويكملنا الطريق اللي بداناه♥️♥️", sender:"مارلين" }
